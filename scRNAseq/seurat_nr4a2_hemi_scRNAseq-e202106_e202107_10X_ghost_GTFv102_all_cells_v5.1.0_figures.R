...
dir.create(path = "./results/smim32_GTFv102/all_cells/figures/temp")

# Define cluster attributes to be used
cluster.attributes <- cluster.attributes$all_cells

# Define rds file name prefix
file.prefix <- "scRNAseq-e20210604_e20210611_scRNAseq-e20210719_e20210720_smim32_GTFv102_cellranger_M3Drop_v3.10.6_danb_seurat_v5.1.0_sctransform_harmony_v1.2.0_unsupervised_clustering_PC1-19_all_cells"

# Load Seurat object
obj <- readRDS(file = file.path("results/smim32_GTFv102/all_cells",
...
umap.plot.l <- mapply(
  ...
  MoreArgs = list(obj = obj,
                  ...
                  save.plot = TRUE,
                  file.name = file.path("results/smim32_GTFv102/all_cells/figures/temp",
...
FixSizeAndSave(plot = metrics.vln.plots,
               filename = file.path("results/smim32_GTFv102/all_cells/figures/temp",
