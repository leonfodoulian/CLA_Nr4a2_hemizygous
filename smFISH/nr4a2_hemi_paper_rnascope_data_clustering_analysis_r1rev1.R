...
setwd(dir = "/Users/leonfodoulian/scData/nr4a2_hemi_scRNAseq-e202106_e202107/RNAscope_data_final/data_r1rev1/")
...
compute.optimal.k.l <- list(TRUE, TRUE)
...
mapply(dir = dirs,
       ...
       FUN = function(dir,
         ...
         # Remove data with cellular and nuclear counts
         files <- files[!grepl(pattern = "cellular.xlsx$|nuclear.xlsx", x = files)]
